...
const Layout = () => {
  const{showditail,setShowditail} = useStateContext()
  ...
  return (
    <div className='flex relative'>
      ...
      <div className='w-full grid grid-cols-2 h-screen'>
        <div className=' col-span-2 md:col-span-1'><Content/></div>
        <div className={showditail?'rounded-xl z-20 absolute top-2 right-1/2 backdrop-blur border border-gray-200 p-2 transition-all duration-500':'rounded-xl z-20 absolute top-2 right-1/2 backdrop-blur border border-gray-200 p-2 transition-all duration-500 hidden'} onClick={()=>(setShowditail(false))}><MdClose size={20}/></div>
